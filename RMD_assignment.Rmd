...
ggplot(data = gapminder, aes(x = lifeExp, y = gdpPercap)) +
  geom_point()
```
This looks like there's a clear relationship between gdp and life expectancy! The plot appears exponential so the same plot was created with a logarithmic scale with base 10 below. 
...
```{r maxlinecharttwo, echo=FALSE, message=FALSE}
